...
import com.example.dogglerapplication.R
import com.example.dogglerapplication.const.Layout.GRID
import com.example.dogglerapplication.data.DataSource
...
val dogList = DataSource.dogs
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val adapterLayout = when (layout) {
            ...
            else -> LayoutInflater.from(parent.context).inflate(R.layout.vertical_horizontal_list, parent, false)
        }
